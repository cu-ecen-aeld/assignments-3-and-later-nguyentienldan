...
void test_validate_my_username()
{
    ...
    const char *userNameFromConf = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(myUserName, userNameFromConf, "The config file and the function are not setup properly");
}
